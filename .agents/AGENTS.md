# NexConvo — Project Context & Agent Rules

The following documentation outlines the project overview, tech stack, architecture principles, and development rules for NexConvo. As an AI agent working on this project, you must adhere to these guidelines at all times.
