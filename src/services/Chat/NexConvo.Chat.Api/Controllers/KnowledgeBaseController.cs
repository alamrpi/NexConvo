...
using NexConvo.Chat.Application.Features.KnowledgeBase.Commands;
...
public sealed class KnowledgeBaseController(ISender sender) : ControllerBase
{
    ...
    {
        // Phase 2: full query handler with filtering and pagination will be implemented here.
    ...
    {
        // Phase 2: full query handler will be implemented here.
        return NotFound();
    }
