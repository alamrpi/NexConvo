...
/**
 * BFF login (frontend standard S3). Exchanges credentials at the gateway, sets the
 * tokens as HttpOnly cookies, and returns ONLY the browser-safe user profile — the
 * access/refresh tokens are never serialized to the client.
 */
