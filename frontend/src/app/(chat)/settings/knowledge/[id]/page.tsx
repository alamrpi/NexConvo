...
const MOCK_DOC_DETAIL = {
  ...
  currentStep: 2, // 0-indexed: 0=Upload, 1=Extract, 2=Chunk, 3=Embed, 4=Index
  versions: [
            ...
            <TableRow key={v.version}>
              ...
              <TableCell className="text-right">
                <div className="flex items-center justify-end gap-2">
                  {restored[v.version] && (
                    <span className="text-xs text-chatConfidence-high">
                      Restored to v{v.version}
                    </span>
                  )}
                  <Button
                    variant="outline"
  ...
  if (editing) {
    return (
      <Input
        ...
        className="text-2xl font-bold tracking-tight h-auto py-0.5 border-0 border-b border-border rounded-none bg-transparent px-0 focus-visible:ring-0"
  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6">
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:underline w-fit"
      ...
      {/* ── Processing steps (only when Processing) ── */}
