...
/**
 * Accessible select (S11/S18). Wraps Radix Select for keyboard operability, typeahead, and
 * a portalled listbox. Tokenized for dark-mode parity (S25); visible focus/disabled states.
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
