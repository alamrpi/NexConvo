...
/**
 * Semantic table primitives (S11/S18) — real <table> elements for screen-reader semantics,
 * tokenized for both themes (S25). No external dependency. Wrap in an overflow container on
 * narrow screens (S24).
 */
